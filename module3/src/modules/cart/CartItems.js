...
import { sendemail, jsonData } from '../../sendemail';
...
function CartItems() {
    ...
    const purchaseOrder = () => {
        ...
        let orderData = {
            ...
            let emailcontent = "You have successfuly redeem your voucher(s) : " + orderData.itemsRedeemed.map((i) => i.item)
            jsonData.body= emailcontent
            sendemail(jsonData)
            ...
            axios.post(API_URL + "history/", orderData)
                ...
                */
                ...
                refreshLoginDetails();
                afterPurchase();
                //to make axios call to send email
